...
#ifndef __ISymUnmanagedCompilerInfoWriter_FWD_DEFINED__
#define __ISymUnmanagedCompilerInfoWriter_FWD_DEFINED__
typedef interface ISymUnmanagedCompilerInfoWriter ISymUnmanagedCompilerInfoWriter;

#endif 	/* __ISymUnmanagedCompilerInfoWriter_FWD_DEFINED__ */
...
#ifndef __ISymUnmanagedCompilerInfoWriter_INTERFACE_DEFINED__
#define __ISymUnmanagedCompilerInfoWriter_INTERFACE_DEFINED__

/* interface ISymUnmanagedCompilerInfoWriter */
/* [unique][uuid][object] */ 


EXTERN_C const IID IID_ISymUnmanagedCompilerInfoWriter;

#if defined(__cplusplus) && !defined(CINTERFACE)
    
    MIDL_INTERFACE("2ae6a06a-92ba-4c2d-a64e-7e9fa421a330")
    ISymUnmanagedCompilerInfoWriter : public IUnknown
    {
    public:
        virtual HRESULT STDMETHODCALLTYPE AddCompilerInfo( 
            /* [in] */ WORD verMajor,
            /* [in] */ WORD verMinor,
            /* [in] */ WORD verBuild,
            /* [in] */ WORD verQFE,
            /* [in] */ __RPC__in const wchar_t *name) = 0;
    ...
    typedef struct ISymUnmanagedCompilerInfoWriterVtbl
    {
        BEGIN_INTERFACE
        
        HRESULT ( STDMETHODCALLTYPE *QueryInterface )( 
            __RPC__in ISymUnmanagedCompilerInfoWriter * This,
            /* [in] */ __RPC__in REFIID riid,
            /* [annotation][iid_is][out] */ 
            _COM_Outptr_  void **ppvObject);
        ...
        HRESULT ( STDMETHODCALLTYPE *AddCompilerInfo )( 
            __RPC__in ISymUnmanagedCompilerInfoWriter * This,
            /* [in] */ WORD verMajor,
            /* [in] */ WORD verMinor,
            /* [in] */ WORD verBuild,
            /* [in] */ WORD verQFE,
            /* [in] */ __RPC__in const wchar_t *name);
        
        END_INTERFACE
    } ISymUnmanagedCompilerInfoWriterVtbl;

    interface ISymUnmanagedCompilerInfoWriter
    {
        CONST_VTBL struct ISymUnmanagedCompilerInfoWriterVtbl *lpVtbl;
    };
...
#define ISymUnmanagedCompilerInfoWriter_QueryInterface(This,riid,ppvObject)	\
    ( (This)->lpVtbl -> QueryInterface(This,riid,ppvObject) ) 

#define ISymUnmanagedCompilerInfoWriter_AddRef(This)	\
    ( (This)->lpVtbl -> AddRef(This) ) 

#define ISymUnmanagedCompilerInfoWriter_Release(This)	\
    ( (This)->lpVtbl -> Release(This) ) 


#define ISymUnmanagedCompilerInfoWriter_AddCompilerInfo(This,verMajor,verMinor,verBuild,verQFE,name)	\
    ( (This)->lpVtbl -> AddCompilerInfo(This,verMajor,verMinor,verBuild,verQFE,name) ) 
...
#endif 	/* __ISymUnmanagedCompilerInfoWriter_INTERFACE_DEFINED__ */
